...
export class HardwareLayout extends LitElement {
  static styles = css`
    ...
    td img.icon-output { float: right; }
    ...
    td img.icon-analog { float: right; }
  ...
  render() {
    return html`
      ...
      <div id="custom_config" class="mui-panel" style="display:${this.customised ? 'block' : 'none'}; background-color: #FFC107;">
      ...
      <div class="mui-panel">
        <form id="upload_hardware" method="POST" action="/hardware">
          ...
          ${this._renderTable()}
          <br>
          <input id="submit-config" type="button" value="Save Target Configuration" class="mui-btn mui-btn--primary" @click=${this._submitConfig}/>
        </form>
      </div>
    `;
  }
  ...
  _renderTable() {
    // Inline the exact table markup from hardware.html to minimize changes
    return html`
      <table>
        <tr><td colspan="2"><b>CRSF Serial Pins</b></td></tr>
        ...
        <tr><td colspan="2"><b>Serial2 Pins</b></td></tr>
        ...
        <tr><td colspan="2"><b>Radio Chip Pins & Options</b></td></tr>
        ...
        <tr><td colspan="2"><b>Radio Antenna</b></td></tr>
        ...
        <tr><td colspan="2"><b>Radio Power</b></td></tr>
        ...
        <tr><td colspan="2"><b>Radio Power Detection</b></td></tr>
        ...
        <!-- FEATURE:IS_TX -->
        <tr><td colspan="2"><b>Analog Joystick</b></td></tr>
        ...
        <tr><td colspan="2"><b>Digital Joystick</b></td></tr>
        ...
        <!-- /FEATURE:IS_TX -->
        <tr><td colspan="2"><b>Mood Lighting</b></td></tr>
        ...
        <tr><td colspan="2"><b>Button(s)</b></td></tr>
        ...
        <!-- FEATURE:IS_TX -->
        <tr><td colspan="2"><b>OLED/TFT (Crotch TV)</b></td></tr>
        ...
        <tr><td colspan="2"><b>Backpack / Logging</b></td></tr>
        ...
        <tr><td colspan="2"><b>I2C & Misc Devices</b></td></tr>
        ...
        <tr><td colspan="2"><b>VBat</b></td></tr>
        ...
        <tr><td colspan="2"><b>SPI VTX</b></td></tr>
