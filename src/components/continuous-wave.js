...
export class ContinuousWave extends LitElement {
        ...
        if(this.data)
            ...
            <div class="mui-panel">
                ...
                <form>
                    ...
                    <!-- /FEATURE:HAS_LR1121 -->
                    <br>
                    <button id="start-cw" class="mui-btn mui-btn--primary" disabled @click="${this._startCW}">Start Continuous Wave</button>
                </form>
                <br>
    ...
    _updateParams(data) {
        ...
        if (FEATURES.HAS_SX128X) {
            this.xtalNominal = 52000000;
            this.warn_offset = 90000;
            this.bad_offset = 180000;
        }
        if (FEATURES.HAS_SX127X || FEATURES.HAS_LR1121) {
            this.xtalNominal = 32000000;
            this.warn_offset = 100000;
            this.bad_offset = 125000;
            if (FEATURES.HAS_LR1121 && !this._('optionsSetSubGHz')?.checked) {
                this.cwFreq = data.center2;
            }
        }
        this._('start-cw').disabled = false;
    }
...
customElements.define('continuous-wave', ContinuousWave);
